...
public class printSourceToDes {

    public void print(Graph2 graph, int start, int end, String path, boolean[] visited){
...
//                visited[node.destination] = true;
    ...
    public void printAllPaths(Graph2 graph, int start, int end){
    ...
    public static void main(String[] args) {
        ...
        graph.addEdge(4, 1);
        graph.addEdge(4, 5);
        printSourceToDes p = new printSourceToDes();
